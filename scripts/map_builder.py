...
RESOLUTION  = 0.10
MAP_HALF    = 14.0
GRID_N      = int(2 * MAP_HALF / RESOLUTION)   # 280
...
class MapBuilder(Node):
    ...
    def _publish_map(self):
        ...
        # Порог 1.5 требует минимум 2 попаданий (2×0.85=1.7>1.5) для показа ячейки
        # как занятой. Это фильтрует одиночные шумовые попадания (в т.ч. саморефлексию).
